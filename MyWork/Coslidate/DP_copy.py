...
class CopyFilesFn(beam.DoFn):
    ...
    def process(self, element):
        ...
        # Get list of files already in the destination
        existing_files = set()
        match_results = FileSystems.match([destination_folder_path + '/*'])
        for match_result in match_results:
            for metadata in match_result.metadata_list:
                existing_files.add(metadata.path)
        ...
        for match_result in match_results:
            for metadata in match_result.metadata_list:
                ...
                if destination_file_path not in existing_files:
                    ...
                    print(f'Skipped {source_file_path}, already exists at {destination_file_path}')
                    yield f'Skipped {source_file_path}, already exists at {destination_file_path}'
